...
interface IEmployee //Create an IEmployeeService interface defining methods like AddEmployee, GetEmployeeById, and GetAllEmployees.
{
...
class Program
{
    ...
    {
        //4. Use Serilog for structured logging (log errors to file and console).

        Log.Logger = new LoggerConfiguration()
          .MinimumLevel.Debug()
          .WriteTo.Console()
          .WriteTo.File("C:/logs/log-3.txt", rollingInterval: RollingInterval.Day)
          .CreateLogger();
        ...
        while (true)
        {
            ...
            switch (choice)
            {
                ...
                {
                        Log.Error(ex, "Invalid input for age.");
                ...
                case "3":
                    ...
                    {
                        Log.Error("Employee Not Found"); //serilog
