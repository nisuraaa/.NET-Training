...
class Program
{
   ...
   .ConfigureServices((context, services) =>
   {
       ...
       // Register GenericRepository as scoped (not singleton) to match DbContext lifetime
       services.AddScoped<GenericRepository<Employee>>();
       services.AddScoped<GenericRepository<Manager>>();

       // Remove duplicate ProjectRepository registration
       // services.AddScoped<ProjectRepository>(); // This line should be removed
   })
   .Build();
