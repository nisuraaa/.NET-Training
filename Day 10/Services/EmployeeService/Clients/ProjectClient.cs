...
public class ProjectHttpClient : IProjectHttpClient
{
    ...
    public async Task<Project?> CreateProjectAsync(string projectName)
    {
        ...
        if (response.IsSuccessStatusCode)
        {
            ...
            return JsonSerializer.Deserialize<Project>(responseContent, new JsonSerializerOptions
            {
    ...
    public async Task<Project?> GetProjectByNameAsync(string name)
    {
        ...
        if (response.IsSuccessStatusCode)
        {
            ...
            return JsonSerializer.Deserialize<Project>(content, new JsonSerializerOptions
            {
                PropertyNameCaseInsensitive = true
            });
        }
